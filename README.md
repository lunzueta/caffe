...
This branch of Caffe is a fusion between the [community based branch led by Guillaume Dumont (@willyd)](https://github.com/bvlc/caffe/tree/windows), the [Microsoft-led Caffe](https://github.com/microsoft/caffe), which includes other functionalities, such as managed-code wrapper, [Faster-RCNN](https://papers.nips.cc/paper/5638-faster-r-cnn-towards-real-time-object-detection-with-region-proposal-networks.pdf) and [R-FCN](https://arxiv.org/pdf/1605.06409v2.pdf), and also hand-picked functionalities from the [NVIDIA-led Caffe](https://github.com/NVIDIA/caffe), such as [DetectNet](https://github.com/NVIDIA/DIGITS/tree/master/examples/object-detection).
